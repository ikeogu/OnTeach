    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <aside className="absolute inset-y-0 left-0 w-64 bg-white flex flex-col shadow-2xl">
            ...
            <nav className="flex-1 p-3 space-y-0.5 overflow-y-auto">
              {navItems.map(({ to, label, icon: Icon, end }) => (
                <NavLink key={to} to={to} end={end} className={navLinkClass} onClick={() => setDrawerOpen(false)}>
                  <Icon />
                  {label}
                </NavLink>
              ))}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-14 shrink-0 bg-white border-b border-gray-200 flex items-center gap-3 px-4">
          ...
          {/* Logo — mobile only */}
          <span className="md:hidden font-bold text-primary">Veologue</span>

          {/* Search — desktop */}
          <div className="hidden sm:flex flex-1 max-w-xs items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-3 py-1.5">
            <svg className="w-4 h-4 text-gray-400 shrink-0" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="ml-auto flex items-center gap-2">
            <button className="w-8 h-8 flex items-center justify-center rounded-lg text-gray-500 hover:bg-gray-50">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 20 20" stroke="currentColor" strokeWidth={1.5}>
                ...
                <path strokeLinecap="round" d="M8 17a2 2 0 0 0 4 0" />
              </svg>
            </button>
...
function DashboardIcon() {
  return <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.5}><rect x="2" y="2" width="5" height="5" rx="1"/><rect x="9" y="2" width="5" height="5" rx="1"/><rect x="2" y="9" width="5" height="5" rx="1"/><rect x="9" y="9" width="5" height="5" rx="1"/></svg>
}
function SessionsIcon() {
  return <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.5}><circle cx="8" cy="8" r="5"/><path strokeLinecap="round" d="M6 6l4 2-4 2V6z" fill="currentColor" stroke="none"/></svg>
}
function AnalyticsIcon() {
  return <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M2 13l3-4 3 2 3-5 3 3"/></svg>
}
function StudentsIcon() {
  return <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.5}><circle cx="6" cy="5" r="2"/><path strokeLinecap="round" d="M2 13c0-2.2 1.8-4 4-4s4 1.8 4 4"/><circle cx="12" cy="5" r="1.5"/><path strokeLinecap="round" d="M10.5 13c0-1.4.8-2.6 2-3.2"/></svg>
}
function SettingsIcon() {
  return <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.5}><circle cx="8" cy="8" r="2"/><path strokeLinecap="round" d="M8 2v1m0 10v1M2 8h1m10 0h1m-2.1-3.9-.7.7M5.8 10.2l-.7.7m0-5.6.7.7m4.4 4.4.7.7"/></svg>
}
function HelpIcon() {
  return <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.5}><circle cx="8" cy="8" r="6"/><path strokeLinecap="round" d="M6.5 6a1.5 1.5 0 0 1 3 .5c0 1-1.5 1.5-1.5 2.5"/><circle cx="8" cy="12" r=".5" fill="currentColor"/></svg>
}
function LogoutIcon() {
  return <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" d="M6 3H3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h3"/><path strokeLinecap="round" d="M10 11l3-3-3-3M13 8H6"/></svg>
}
